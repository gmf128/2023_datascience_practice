...
parser.add_argument('--trained_model',
                    default='..//weights/ssd300_COCO_10000.pth', type=str,
                    help='Trained state_dict file path to open')
parser.add_argument('--save_folder', default='../results/val/', type=str,
...
def get_voc_results_file_template(image_set, cls):
    # data/results/det_test_aeroplane.txt
